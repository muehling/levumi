...
dicN1 = TestDictation.create(name: "Wörter schreiben", info: "", short_info: "", len: items.size/2, time: 60, subject: "Deutsch", construct: "Rechtschreibung",
...
while i<items.size do
  it = dicN1.items.build(itemtext: items[i], mediapath:items[i+1], difficulty: 0, itemtype:0, itemview:"
  <audio id='audioItem'></audio>
<p align='center'>
...
it = dicN1.items.build(itemtext: "Ende", difficulty: 0, mediapath: "Anweisungen/20_geschafft.mp3", itemtype:1, itemview:"
<audio id='audioItem'></audio>
<p style='font-family: fibel_nordregular; font-size:60px' class='text-center'>
