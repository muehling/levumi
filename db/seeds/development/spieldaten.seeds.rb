...
it = dicN1.items.build(itemtext: "Hallo", difficulty: 0, audiopath: "Anweisungen/15_Hallo.mp3", itemtype:-4, itemview:"
...
it.save
it = dicN1.items.build(itemtext: "Erklärung", difficulty: 0, audiopath: "Anweisungen/15_Erklärung.mp3", itemtype:-3,itemview:"
<audio id='audioItem'></audio>
<p style='font-family: fibel_nordregular; font-size:60px' class='text-center'>
...
it.save
it = dicN1.items.build(itemtext: "Löschen und Audio", difficulty: 0, audiopath: "Anweisungen/16_ErklärungTeilB.mp3", itemtype:-2,  itemview:"
<audio id='audioItem'></audio>
<p style='font-family: fibel_nordregular; font-size:60px' class='text-center'>
...
it.save
it = dicN1.items.build(itemtext: "Ich beginne", difficulty: 0, audiopath: "Anweisungen/19_ich_beginne.mp3", itemtype:-1, itemview:"
<audio id='audioItem'></audio>
<p style='font-family: fibel_nordregular; font-size:60px' class='text-center'>
...
while i<items.size do
  it = dicN1.items.build(itemtext: items[i], audiopath:items[i+1], difficulty: 0, itemtype:0, itemview:"
  <audio id='audioItem'></audio>
<p align='center'>
