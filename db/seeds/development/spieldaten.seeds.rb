...
t = TestDictationLisa.create(name: "Diktiertest", len: 8, info: "Diktiertest für die Grundschule, 1. Klasse", short_info:
...
i = t.items.build(itemtext: "Hallo", difficulty: 0.1, audiopath: "/assets/Anweisungen/15_Hallo.mp3", itemview:"
...
i.save
i = t.items.build(itemtext: "Erklärung", difficulty: 0, audiopath: "/assets/Anweisungen/15_Erklärung.mp3",itemview:"
...
i.save
i = t.items.build(itemtext: "Löschen und Audio", difficulty: 0, audiopath: "/assets/Anweisungen/16_ErklärungTeilB.mp3",  itemview:"
...
i.save
i = t.items.build(itemtext: "Ich beginne", difficulty: 0, audiopath: "/assets/Anweisungen/19_ich_beginne.mp3", itemview:"
...
i.save
i = t.items.build(itemtext: "Flug", difficulty: 0.1, audiopath: "/assets/Woerter/4_Flug.mp3", itemview:"
<audio id='audioItem' src='/assets/Woerter/4_Flug.mp3'></audio>
<p align='center'>
...
i.save
i = t.items.build(itemtext: "einer", difficulty: 0.4, audiopath: "/assets/Woerter/15_einer.mp3", itemview:"
<audio id='audioItem' src='/assets/Woerter/15_einer.mp3'></audio>
<p align='center'>
  <input style='font-family: fibel_nordregular; font-size:96px' id='answer' type='text' class='text-center' align='middle'>
</p>
<br />
...
i.save
i = t.items.build(itemtext: "Keller", difficulty: 0.7, audiopath: "/assets/Woerter/33_Keller.mp3",  itemview:"
<audio id='audioItem' src='/assets/Woerter/33_Keller.mp3'></audio>
<p align='center'>
  <input style='font-family: fibel_nordregular; font-size:96px' id='answer' type='text' class='text-center' align='middle'>
</p>
<br />
...
i.save
i = t.items.build(itemtext: "Ende", difficulty: 0.1, audiopath: "/assets/Anweisungen/20_geschafft.mp3", itemview:"
