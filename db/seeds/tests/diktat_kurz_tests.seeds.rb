...
dicN1 = Test.create(name: "Wörter schreiben", info: "", type_info:"Diktiertest", short_info: "WSK", len: items.size, time: 2400, subject: "Deutsch", construct: "Rechtschreibung", student_access:true, level: "Kurztest", archive: false)
