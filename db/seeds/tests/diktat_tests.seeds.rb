...
dicN1 = TestDictation.create(name: "Wörter schreiben", info: "", short_info: "", len: items.size, time: 900, subject: "Deutsch", construct: "Rechtschreibung", student_access:true, level: "Level 1", archive: false)
