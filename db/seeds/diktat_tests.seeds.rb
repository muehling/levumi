...
dicN1 = TestDictation.create(name: "Wörter schreiben", info: "", short_info: "", len: items.size/2, time: 1200, subject: "Deutsch", construct: "Rechtschreibung", student_access:true, level:"Level nicht bestimmt")

it = dicN1.items.build(itemtext: "Hallo", difficulty: 0, itemtype: -4, mediapath: "Anweisungen/15_Hallo.mp3", itemview:"
...
it.save
it = dicN1.items.build(itemtext: "Erklärung", difficulty: 0, itemtype: -3, mediapath: "Anweisungen/15_Erklärung.mp3",itemview:"
<audio id='audioItem'></audio>
<p style='font-family: fibel_nordregular; font-size:60px' class='text-center'>
...
it.save
it = dicN1.items.build(itemtext: "Löschen und Audio", difficulty: 0, itemtype: -2, mediapath: "Anweisungen/16_ErklärungTeilB.mp3",  itemview:"
<audio id='audioItem'></audio>
<p style='font-family: fibel_nordregular; font-size:60px' class='text-center'>
...
it.save
it = dicN1.items.build(itemtext: "Ich beginne", difficulty: 0, itemtype: -1, mediapath: "Anweisungen/19_ich_beginne.mp3", itemview:"
<audio id='audioItem'></audio>
<p style='font-family: fibel_nordregular; font-size:60px' class='text-center'>
...
while i<items.size do
  it = dicN1.items.build(itemtext: items[i], mediapath:items[i+1], itemtype: 0, difficulty: 0, itemview:"
  <audio id='audioItem'></audio>
<p align='center'>
