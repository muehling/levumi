        ...
        <b-card :title="`${login.intro_state > 0 ? 'Geänderte ' : ''}Nutzungsbedingungen`">
          <div>
            <p class="text-justify">
              ...
              Arbeitsgruppen der CAU Kiel und der Universität Regensburg betrieben, der Dienst wird
              auf Servern der Universität Kiel bereitgestellt. Die Nutzung von Levumi setzt voraus,
              dass Sie unseren hier dargestellten Nutzungsbedingungen zustimmen. Bitte lesen Sie
