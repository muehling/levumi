<template>
  <BModal
    ...
    <address>
      <strong>Christian-Albrechts-Universität zu Kiel</strong>
    ...
    <p>
      ...
      <a href="mailto:markus.gebhardt@lmu.de">markus.gebhardt@lmu.de</a>
      )
      <br />
      Prof. Dr. Andreas Mühling (
      <a href="mailto:andreas.muehling@informatik.uni-kiel.de">
...
<script>
  ...
  export default {
    ...
    methods: {
      close() {
        this.store.generalModals.isImprintOpen = false
      },
    },
  }
</script>
