<template>
  <div>
    <div>
      <section>
        <div class="flex-fill">
          <div class="img_container children-img position-relative">
            <h1 class="hero-header mb-auto display-2 m-4">Willkommen bei Levumi!</h1>
      ...
      <section class="text-center mt-3" aria-label="Blog, Videobeschreibung und Newsletter">
        <p id="blog-description" class="lead">
          ...
          unterstützt Sie bei allen Fragen rund um die Plattform und informiert über praxisrelevante
      ...
      <section class="text-center mt-3" aria-label="Blog, Videobeschreibung und Newsletter">
        <p class="lead">
          Durch regelmäßige, kurze Testungen werden Lernzuwächse und Problemfelder sichtbar.
          <br />
          Wir bieten aktuell unter anderem Tests zum Lesen, zur Rechtschreibung und für Mathematik
          an.
          <br />
          Wenn es Fördermaterial gibt, so wird Ihnen dieses spezifisch für Ihre Schüler:innen
          empfohlen.
          <br />
          Sie können sich auch Notizen zu den Lernverläufen direkt in Levumi machen!
          <br />
