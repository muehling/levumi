...
class Student < ActiveRecord::Base
  ...
  def self.xls_headings
    return %w{ID Code Klasse Geschlecht Geburtsdatum Förderbedarf Migrationshintergrund}
  end

  def to_a
    return [id.to_s, name, group.id, get_gender(true), get_birthdate(true), get_specific_needs(true), get_migration(true)]
  end
