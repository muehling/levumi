...
class MeasurementsController < ApplicationController
  ...
  private
    ...
    def is_allowed
      unless !@login_user.nil? && @login_user.account_type!=-1 && (!@login_user.nil? && @login_user.hasCapability?("admin") || params.has_key?(:user_id) && (@login_user.id == params[:user_id].to_i))
